...
function validate (opts) {
  ...
  opts.collection = 
    opts.collection || 
    c.collection.GROSSING || 
    c.collection.NEW_FREE ||
    c.collection.NEW_PAID ||
    c.collection.TOP_FREE ||
    c.collection.TOP_FREE_GAMES ||
    c.collection.TOP_GROSSING_GAMES ||
    c.collection.TOP_PAID ||
    c.collection.TOP_PAID_GAMES ||
    c.collection.TRENDING;
